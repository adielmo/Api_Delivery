...
import static com.rabelo.delivery.domain.repository.spec.RestauranteSpacs.comNomeSemelhante;
...
import com.rabelo.delivery.domain.repository.spec.RestauranteSpacs;


@Repository
public class RestauranteRepositoryImpl implements RestauranteRepositoryQuereis {
	...
	public List<Restaurante> findComFreteGratis(String nome) {
		 ...
		 return restauranteRepository.findAll(RestauranteSpacs.comFreteGratis().and(comNomeSemelhante(nome)));
	}
